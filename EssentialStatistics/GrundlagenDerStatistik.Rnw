...
Der p-Wert ist die am häufigsten benutzte, aber leider auch am schwierigsten zu interpretierende Methode. 
...
\begin{figure}[htb]
\begin{center}
\includegraphics[width = 8cm]{ErrorTypes}
\caption{E}
